...
namespace Fichadetrabalho2
{
    internal class Avarias
    {
        ...
        private DateTime data;          //dd-mm-aaaa hh:mn
        private string nomeCliente;     //limitar a 50 caracteres
        private long telefone;          //9 dígitos
        private string email;           //não vazio
        private string avaria;          //item da combobox
        private Boolean garantia;       // 0 ou 1
